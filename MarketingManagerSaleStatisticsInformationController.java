 ...
 * @version 0.99
 */
public class MarketingManagerSaleStatisticsInformationController extends AbstractController {

	/**
	 * holding an instance of this controller here
	 */
	public static MarketingManagerSaleStatisticsInformationController instance;
	...
	void help_btn_clicked(MouseEvent event) {
		...
		dia.setContentText(
				"Sale Statistics Information Screen\nIn this screen marketing manager can see statistics from the analytic system\n"
	...
	void logout_btn_clicked(MouseEvent event) {
		...
		Message message = new Message(MessageType.LOGOUT, "SaleStatisticsInformationController_logout_clicked", quary);
	...
	void find_btn_clicked(MouseEvent event) {
		...
		if (choose_flag == true) {
			...
			if (All_flag == 1) {
				Message msg = new Message(MessageType.REQUESTINFO, "SaleStatisticsInformationController_all_comboBox",
						all_query.toString());
		...
		Message msg = new Message(MessageType.REQUESTINFO, "SaleStatisticsInformationController_count_choosen_box",
				query.toString());
		MainClientGUI.client.handleMessageFromClientUI(msg);
	...
	public void return_counter_comboBox(ArrayList<ArrayList<Object>> conut_for_comboBox) {
		...
		Message msg = new Message(MessageType.REQUESTINFO, "SaleStatisticsInformationController_general_counter",
				query);
		MainClientGUI.client.handleMessageFromClientUI(msg);
